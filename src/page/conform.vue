		...
		<div class="con-table">
			...
			<template v-if="isajax">
				...
				<template v-if="list&&list.length>0">
					<router-link class="con-top" v-for="(el,i) in list" :key="i" :to="{path:'/introduce',query:{id:el.comId,name:el.comName,source:el.regisAddress}}"
					 target='_blank' @click.native='store(el)'>
						<div class="left" style="width:70px">
							{{(current-1)*20+(i+1)}}
						</div>
						<div class="left" style="width:300px">
