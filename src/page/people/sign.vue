	...
	<div class="sign">
		...
		<div class="sign-table">
			<div class="certifi-table">
				...
				<div style="width:80px;">专业</div>
				<div style="width:153px;">证书编号</div>
				<div style="width:200px;">单位名称</div>
				<div style="width:110px;">有效期</div>
			</div>
			<div class="certifi-in" v-for="(el,i) in list" :key="i">
				<div style="width:70px;">{{i + 1 }}</div>
				<div style="width:160px;">{{el.category}}</div>
				<div style="width:80px;">{{el.major}}</div>
				<div style="width:153px;">{{el.sealNo}}</div>
				<div style="width:200px;" class="box-p">{{el.comName}}</div>
				<div style="width:110px;">{{el.validDate}}</div>
			</div>
