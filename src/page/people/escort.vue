	...
	<div class="sign">
		...
		<div class="sign-table">
			<div class="certifi-table">
				...
				<div style="width:260px;">单位名称</div>
				<div style="width:253px;">工程名称</div>
				<!-- <div style="width:100px;" >
           建设单位
         </div> -->
				<div style="width:100px;">岗位类别</div>
				<!-- <div style="width:90px;" >
           所在市州
         </div> -->
				<div style="width:110px;">押证时间</div>
			</div>
           ...
           {{el.proOrg}}
				...
				<div style="width:100px;">{{el.type}}</div>
				<!-- <div style="width:90px;" >
           {{el.city}}
         </div> -->
				<div style="width:110px;">{{el.date}}</div>
			</div>
